package ru.dienet.wolfy.game.game.gameObjects;

import android.graphics.Rect;

import ru.dienet.wolfy.game.framework.interfaces.Image;
import ru.dienet.wolfy.game.game.Assets;
import ru.dienet.wolfy.game.game.GameScreen;
...
public class Tile {
	...
	public void update() {
		...
		if (type != 0 && Rect.intersects(r, Robot.yellowRed)) {
